    ...
    <>
      ...
      <header className="topbar">
        <div className="topbar-brand">
          <svg className="brand-logo" viewBox="0 0 4087 1024" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Piana Care">
            <g id="logo-left">
